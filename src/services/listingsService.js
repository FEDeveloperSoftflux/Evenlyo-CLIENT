...
class ListingsService {
  ...
  async getListingByFilter(filterParams) {
    try {
      const response = await api.post(endPoints.listings.filter, filterParams);
      return {
        success: true,
        listings: response.data.listings,
      };
...
export const { getListingByFilter } = new ListingsService();
export const { getListingById } = new ListingsService();