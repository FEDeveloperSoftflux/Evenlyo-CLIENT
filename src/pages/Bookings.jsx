...
function Bookings() {
  ...
  const getStatusBadge = (status) => {
    const colorMap = {
      ...
      'Rejected': 'bg-red-200 text-red-800 font-medium',        // Light Red bg, Red text
      'Paid': 'bg-purple-200 text-purple-800 font-medium',                 // Purple bg, White text
      'Picked Up': 'bg-blue-800 text-white font-medium',            // Dark Blue bg, White text
      'Complete': 'bg-green-800 text-white font-medium',             // Dark Green bg, White text
      'Claim': 'bg-orange-300 text-orange-900 font-medium',            // Light Orange bg, Orange text
      'Accepted': 'bg-green-100 text-green-600',         // Light Blue bg, Blue text
      'Pending': 'bg-green-100 text-green-800 font-medium',          // Light Pink bg, Pink text
    };
